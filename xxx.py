...
# Create an HTMLLabel widget
    ...
    html_content = f'<span style="font-family: Arial; font-size: 12pt;">Текст с нужным шрифтом</span>'

     # Чтение содержимого файла
    with open(r"C:\Users\Andrii\Desktop\1\diplom\front\main.html", "r") as file:
